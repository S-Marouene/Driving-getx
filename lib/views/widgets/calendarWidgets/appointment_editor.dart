...
Widget _deleteRecurrence(BuildContext context, SampleModel myModel,
                    ...
                    return WillPopScope(
                        ...
                        child: Theme(
                          ...
                          child: _deleteRecurrence(
                              context, myModel, selectedAppointment, events),
                        ));
                  });
            }
          },
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          onPressed:
                                                                            ...
                                                                            final DateTime? pickedDate = await showDatePicker(
                                                                                ...
                                                                                builder: (BuildContext context, Widget? child) {
                                                                                  return Theme(
                                                                                    data: ThemeData(brightness: Theme.of(context).colorScheme.brightness, colorScheme: _getColorScheme(widget.model, true), primaryColor: widget.model.backgroundColor),
                                                                                    child: child!,
                                                                                  );
                                                                                });
                                                                            if (pickedDate ==
                              ...
                              SizedBox(
                                ...
                                child: TextField(
                                  ...
                                  onChanged: (String value) {
                                    ...
                                    _recurrenceProperties!.dayOfMonth =
                                        _dayOfMonth;
                                    _weekIconColor = Theme.of(context)
                                                .colorScheme
                                                .brightness ==
                                            Brightness.dark
                                        ? Colors.white
    ...
    return Theme(
        ...
        child: Scaffold(
            backgroundColor:
                ...
                Theme.of(context).colorScheme == Brightness.dark
                    ? Colors.grey[850]
                    : Colors.white,
            appBar: AppBar(
